...
public class RenderPlayer extends RenderLiving {
	public ModelCharacter modelBipedMain;
	public ModelCharacter modelArmorChestplate;
	public ModelCharacter modelArmor;
	...
	public RenderPlayer() {
		...
		this.mainModel = new ModelCharacter();
		this.modelBipedMain = new ModelCharacter();
		this.modelArmorChestplate = new ModelCharacter();
		this.modelArmor = new ModelCharacter();
	}
	...
	protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2) {
		...
		if (var22 != null) {
			GL11.glPushMatrix();
			this.modelBipedMain.rarm1.postRender(0.0625F);
	...
	public void func_82441_a(EntityPlayer par1EntityPlayer) {
		...
		if (!AerisRenderHelper.renderFirstPerson(par1EntityPlayer, this)) {
			this.modelBipedMain.onGround = 0.0F;
			this.modelBipedMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, par1EntityPlayer);
			this.modelBipedMain.rarm1.render(0.0625F);
		}
	}
