...
public abstract class Minecraft implements Runnable, IPlayerUsage {
	...
	/** Max world height in blocks */
	public static final int maxBuildHeight = 512;
	public static final int maxBuildHeight1 = 513;
	...
	public void startGame() throws LWJGLException {
		...
		this.mcDataDir = new File(Minecraft.class.getResource("/").getPath());
		this.mcAssetDir = new File(Minecraft.class.getResource("/").getPath().substring(0, Minecraft.class.getResource("/").getPath().length() - 4) + "data");
		this.mcAssetDir.mkdir();

		this.saveLoader = new AnvilSaveConverter(new File(this.mcAssetDir, "saves"));
		this.gameSettings = new GameSettings(this, this.mcAssetDir);
		this.texturePackList = new TexturePackList(0, this.mcAssetDir, this);
		...
		this.statFileWriter = new StatFileWriter(this.session, this.mcAssetDir);
	...
	private void checkGLError(String par1Str) {
		...
		if (var2 != 0) {
			...
			System.err.println("OpenGL Error at " + par1Str + ". " + var2 + ": " + var3);
		}
	}
