...
public class RenderEngine
{
    ...
    public RenderEngine(TexturePackList par1TexturePackList, GameSettings par2GameSettings)
    {
        ...
        var3.fillRect(0, 0, 64, 10);
        var3.setColor(Color.MAGENTA);
        var3.fillRect(0, 10, 32, 22);
        var3.fillRect(32, 32, 32, 32);
        var3.setColor(Color.BLACK);
        var3.fillRect(32, 10, 32, 22);
        var3.fillRect(0, 32, 32, 32);
        var3.drawString("Missingno", 0, 9);
        var3.setColor(Color.WHITE);
    ...
    public int[] getTextureContents(String par1)
    {
    	String par1Str = "/assets" + par1;
    ...
    public int getTexture(String par1)
    {
    	String par1Str = "/assets" + par1;
