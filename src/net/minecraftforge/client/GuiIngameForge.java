...
import net.minecraft.client.aeris.AerisRenderHelper.IHelmetOverlay;
	...
	private void renderHelmet(ScaledResolution res, float partialTicks, boolean hasScreen, int mouseX, int mouseY) {
		...
		if (this.mc.gameSettings.thirdPersonView == 0 && itemstack != null && itemstack.getItem() != null) {
			if (itemstack.itemID == Block.pumpkin.blockID) {
				...
				if (itemstack.getItem() instanceof IHelmetOverlay) {
					((IHelmetOverlay) itemstack.getItem()).renderHelmetOverlay(itemstack, mc.thePlayer, res, partialTicks, hasScreen, mouseX, mouseY);
				}
			}
		}
